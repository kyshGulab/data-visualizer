    ...
    if uploaded_file is not None:
        ...
        if selected_columns:
            ...
            if question:
                ...
                prompt = f"The user has selected columns: {', '.join(selected_columns)}. 
                ...
                Please only provide the code for the visualization and include a short sentence about what insights the visual will help the user gain, suggest at least three different visuals when possible. Assume the dataset is already loaded."
