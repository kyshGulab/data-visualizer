...
if question:
  ...
  prompt = f"use python to Generate code to construct a data visual to answer '{question}' based on the following columns: {', '.join(selected_columns)}. Only provide the code and nothing else. only use the data in the df provided by the user, nothing else."  
